...
class EmotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emotion" do
    assert_difference('Emotion.count') do
      post emotions_url, params: { emotion: { action: @emotion.action, feelings: @emotion.feelings, scale: @emotion.scale, thought: @emotion.thought, trigger: @emotion.trigger } }
    end
  ...
  test "should update emotion" do
    patch emotion_url(@emotion), params: { emotion: { action: @emotion.action, feelings: @emotion.feelings, scale: @emotion.scale, thought: @emotion.thought, trigger: @emotion.trigger } }
